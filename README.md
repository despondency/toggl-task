...
I'd write httptest unit tests for the handlers even though there is an integration tests. For the persisters and mongo as well. It's going to be mostly mocking and verification of ops.
